...
\hline
2478 & \hypertarget{row:2478}{jafna, líking} & \hyperlink{row:1515}{Yrðing} sem lýsir því að tvær \hyperlink{row:5102}{stærðir} séu jafnar & Dæmi um jöfnu er staðhæfingin $q(x)$: „$x^2 = 1$“ sem er jafna með óþekktu \hyperlink{row:5102}{stærðina} $x$. Þegar talan $-1$ er sett í stað óþekktu stærðarinnar fæst staðhæfingin $p(-1)$: „$(-1)^2 = 1$“, sem er \hyperlink{row:6659}{sönn} yrðing. Þegar talan $-2$ er sett í stað óþekktu stærðarinnar fæst hins vegar staðhæfingin $p(-2)$: „$(-2)^2 = 1$“, sem er \hyperlink{row:6624}{ósönn} yrðing &  \\
\hline
