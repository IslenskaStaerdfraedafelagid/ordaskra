...
\hline
4464 & \hypertarget{row:4464}{sammengi} & \textit{Sammengi} tveggja \hyperlink{row:3270}{mengja} $A$ og $B$ er mengi þeirra \hyperlink{row:5128}{staka} sem eru að minnsta kosti í öðru þeirra. Þetta mengi er táknað með $A \cup B$ (lesið: $A$ sam $B$) og það má rita á forminu \[ A \cup B = \{x \mid x \in A \text{ eða } x \in B\}. \] & Á Venn-myndinni hér að neðan er $A \cup B$ litað rautt:
