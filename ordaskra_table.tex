...
2835 & leiðiliður &  &  &  \\
\hline
2836 & leiðing & <ref idTerm=2836>Yrðing</ref> af taginu $A \implies B$ kallast \textit{leiðing} en  $A$ kallast þá \textit{skilyrði} og $B$ \textit{ályktun} &  & Niðurstaða? \\
\hline
2837 & leiðingarmerki &  &  &  \\
\hline
2838 & leiðingarregla &  &  &  \\
...
Eftirfarandi eru fleiri dæmi um gröf algengra falla: 

\begin{figure}
\begin{center}
\includegraphics[width=150px]{myndir/graf_samsemdarvorpun.png}
\end{center}
\caption{Samsemdarvörpunin $f(x) = x$, $x \in \mathbb{R}$}
\end{figure} & Laga bakgrunnslit \\
\hline
