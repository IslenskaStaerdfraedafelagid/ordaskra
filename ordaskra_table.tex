...
2954 & linur & & &  \\
\hline
2955 & línurit, fallrit, varprit, ferill (falls) & Fyrir <ref idTerm=3282>vörpun</ref> $f: X \to Y$ kallast <ref idTerm=3270>mengi</ref> allra <ref idTerm=5627>tvennda</ref> af gerðinni $(x,f(x))$, þar sem $x \in X$ \textit{graf} vörpunarinnar $f$ og er táknað með $G_f = \{(x,f(x)) \mid x \in X\} \] & & Vantar þýðinguna "graf" \\
\hline
