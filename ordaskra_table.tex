\begin{longtable}{p{0.03\textwidth} | p{0.22\textwidth} | p{0.22\textwidth} |
p{0.22\textwidth} |
p{0.22\textwidth}}
\hline
\textbf{id} & \textbf{Hugtök} & \textbf{Skilgreining} & \textbf{Skýring} & \textbf{Athugasemdir} \\
\hline
1 & -und, -d & & & Á mögulega ekki heima í íðorðabók \\
\hline
2 & \(\phi\)-fall Eulers & & &  \\
\hline
3 & \(A\)-stöðugleiki & & &  \\
...
50 & aðgreina & & &  \\
\hline
51 & aðgreinandi, aðgreinir, aðskilja & & &  \\
\hline
...
64 & aðhvarfsstuðull & & &  \\
\hline
65 & aðlæg hlið & Tvær <ref idTerm=2048>hliðar</ref> <ref idTerm=3161>marghyrnings</ref> sem skerast í nákvæmlega einum <ref idTerm=4001>punkti</ref> kallast \textit{aðlægar hliðar} & &  \\
\hline
...
\hline
194 & algildi, lengd, tölugildi & \textit{Algildi} <ref idTerm=4093>rauntölunnar</ref> $x$ er táknað með $|x|$ og skilgreint með <ref idTerm=2478>jöfnunni</ref> \[ |x| = \begin{cases} x & \text{ef} \; x \geq 0,\\ - x & \text{ef} \; x \lt 0. \end{cases} \]  & &  \\
\hline
195 & algildisflötur & & &  \\
\hline
...
\hline
273 & andhverfa (vörpunar), andhverf vörpun & Sjá <ref idTerm=274>andhverfanlegur</ref> & &  \\
\hline
274 & andhverfanlegur & <ref idTerm=3282>Vörpun</ref> $f: X \to Y$ er sögð \textit{andhverfanleg} ef til er vörpun $g: Y \to X$ þannig að <ref idTerm=4518>samskeyting</ref> varpananna $f$ og $g$ annars vegar og $g$ og $f$ hins vegar sé viðeigandi <ref idTerm=4498>samsemdarvörpun</ref>, þ.e. \[ g \circ f = \mathrm{id}_X \quad \text{og} \quad f \circ g = \mathrm{id}_Y \] Ef slík vörpun $g$ er til <ref idTerm=3932>ákvarðast hún ótvírætt</ref> af þessum skilyrðum og kallast þá \textit{andhverfa} vörpunarinnar $f$ og er yfirleitt táknuð með $f^{-1}$ & & Þetta hugtak á við um meira en bara varpanir, þarf líka færslu fyrir andhverfanlega vörpun (óvart hent út)  \\
\hline
...
\hline
291 & andsamhverf marglínuleg vörpun, oddhverf marglínuleg vörpun & & &  \\
\hline
292 & andsamhverf vensl & & &  \\
\hline
...
456 & biðtími & & &  \\
\hline
457 & bil & <ref idTerm=2098>Hlutmengi</ref> $I$ í <ref idTerm=3270>mengi</ref> <ref idTerm=4093>rauntalna</ref> kallast \textit{bil} ef fyrir sérhver $x, y \in I$ og $z \in \mathbb{R}$ þannig að $x < z < y$ gildi að $z \in I$ & & Tala um endapunkta? \\
\hline
458 & bilanatíðni, óhappatíðni & & &  \\
\hline
459 & bilanet & & &  \\
\hline
460 & binda & & &  \\
\hline
461 & biti, tvíundatölustafur & & &  \\
\hline
...
684 & deiling & & &  \\
\hline
685 & deiling án afgangs & <ref idTerm=686>Heiltöludeiling</ref> þar sem afgangurinn er 0 & &  \\
\hline
...
1029 & evklíðsk firð & & &  \\
\hline
1030 & evklíðsk rúmfræði & & &  \\
\hline
1031 & evklíðsk slétta & & &  \\
\hline
...
\hline
1075 & faldmengi, mengjamargfeldi, margfeldismengi & Fyrir tvö <ref idTerm=3270>mengi</ref> $X$ og $Y$ kallast mengi <ref idTerm=5627>tvennda</ref> $(x,y)$ þar sem $x \in X$ og $y \in Y$ \textit{faldmengi} $X$ og $Y$ og er táknað með $X \times Y$ & & Tala um almennt faldmengi (fyrir fleiri en tvö mengi) í skýringu \\
\hline
...
\hline
1157 & ferningsrót, önnur rót & Lausn á <ref idTerm=2478>jöfnu</ref> af gerðinni $x^2 = a$ kallast \textit{kvaðratrót} af $a$. Sjá <ref idTerm=4253>rót</ref> & & Á að vitna svona í færsluna fyrir rót til þess að skilgreina rótarstofn og rótarvísi? \\
\hline
...
1193 & fínt knippi & & &  \\
\hline
1194 & firð & Firð á <ref idTerm=3270>mengi</ref> $M$ er <ref idTerm=1078>fall</ref> $d:M \times M \to \mathbb{R}_+$, sem <ref idTerm=1504>uppfyllir</ref> 
...
1596 & Galois-kenning & & &  \\
\hline
1597 & Galois-útvíkkun, Galois-víkkun & & &  \\
\hline
1598 & gammafall & & &  \\
\hline
1599 & ganga upp í & & &  \\
...
1645 & gjaldþrot, hrun & & &  \\
\hline
1646 & gleiðhyrndur, sljóhyrndur & <ref idTerm=6438>Þríhyrningur</ref> 
%kallast \textit{gleiðhyrndur} ef eitt <ref idTerm=2198>horna</ref> hans er 
með eitt <ref idTerm=1647>gleitt</ref> <ref idTerm=2198>horn</ref>.
%, þ.e. stærra en <ref idTerm=4167>rétt horn</ref> 
& &  \\
\hline
...
\hline
1809 & hágildissetning, hágildislögmál & & &  \\
\hline
...
<ref idTerm=5102>Stærðirnar</ref> $a_{i}x^i$ kallast \textit{liðir} margliðunnar og kallast þá $a_{n}x^n$ \textit{forystuliður} hennar og $a_{0}$ \textit{fastaliður} hennar. Margliða sem hefur enga liði aðra en fastaliðinn kallast \textit{fastamargliða}.
...
2047 & hlið & & &  \\
\hline
2048 & hlið, hliðarlína, hliðarstrik & & &  \\
\hline
2049 & hliðarhorn & & &  \\
\hline
...
%er \textit{hvasshyrndur} ef öll <ref idTerm=2198>horn</ref> hans eru <ref idTerm=2317>hvöss</ref>, þ.e. minni en <ref idTerm=4167>rétt horn</ref> 
& &  \\
\hline
...
2488 & jafngildi & & &  \\
\hline
2489 & jafngildisflokkur & <ref idTerm=2098>Hlutmengi</ref> $A$ í <ref idTerm=3270>mengi</ref> $X$ sem uppfyllir fyrir öll $x,y \in A$ að $x$ og $y$ séu <ref idTerm=0>vensluð saman</ref> með tilliti til tiltekinna jafngildisvensla og að $x \in A$ sé ekki venslað saman við neitt <ref idTerm=5128>stak</ref> í $X \setminus A$ & & Vantar færslu fyrir jafngildisvensl \\
\hline
2490 & jafngildur & & &  \\
\hline
...
\hline
2554 & kartesk hnit, Kartesarhnit & & &  \\
\hline
2555 & kartesk slétta, Kartesarslétta & & &  \\
\hline
2556 & karteskt rúm, Kartesarrúm & & &  \\
\hline
2557 & karteskur ferningur & & &  \\
\hline
2558 & karteskur, Descartes-, Kartes- & & &  \\
\hline
...
\hline
2759 & lággildi, staðbundið lággildi & & &  \\
\hline
2760 & lággildispunktur & & &  \\
\hline
2761 & lággildissetning, lággildislögmál & & &  \\
\hline
...
3015 & lokaður & & &  \\
\hline
3016 & lokaður ferill, lokaður vegur, lykkja & & &  \\
\hline
...
\hline
3134 & margföld flokkun & & &  \\
\hline
3135 & margföld núllstöð & & &  \\
\hline
3136 & margföld ör & & &  \\
\hline
3137 & margföld rakning & & &  \\
\hline
3138 & margföld röð & & &  \\
\hline
3139 & margföld rót & & &  \\
...
3141 & margföldun & & &  \\
\hline
3142 & margföldun fjöldatalna & & &  \\
\hline
3143 & margföldun frá hægri, hægri margföldun & & &  \\
\hline
3144 & margföldun frá vinstri, vinstri margföldun & & &  \\
\hline
3145 & margföldun í kross & & &  \\
\hline
3146 & margföldun, reikniaðgerð rituð sem margföldun & & &  \\
\hline
3147 & margföldunar- & & &  \\
\hline
...
\hline
3153 & margföldunarumhverfa, margföldunarandhverfa, umhverfa & & &  \\
\hline
...
\hline
3161 & marghyrningur, hyrningur & <ref idTerm=4891>Flatarmynd</ref> með <ref idTerm=2453>jaðri</ref> sem samanstendur af <ref idTerm=1009>endanlega</ref> mörgum <ref idTerm=2958>línustrikum</ref> & & Hvað er hægt að segja annað en jaðar í tveimur víddum? \\
\hline
...
3281 & mengjaríki & & &  \\
\hline
3282 & vörpun & \textit{Vörpun} $f: X \to Y$ frá <ref idTerm=3270>mengi</ref> $X$ yfir í mengið $Y$ er forskrift eða regla sem úthlutar sérhverju <ref idTerm=5128>staki</ref> úr $X$ nákvæmlega einu staki úr $Y$. Mengið $X$ kallast \textit{skilgreiningarmengi} vörpunarinnar og mengið $Y$ kallast \textit{bakmengi} hennar. 
%Rithátturinn $f: X \to Y$ er notaður til að tákna vörpun $f$ með skilgreiningarmengi $X$ og bakmengi $Y$ og ef forskrift hennar er þekkt er hún látin fylgja 
& & Líka taka fram að ef bakmengið er $\mathbb{R}$ eða $\mathbb{C}$ er talað um fall frekar en vörpun? Koma þessu inn einhvern veginn?: Stakið úr $Y$ sem $f$ úthlutar $x$ er táknað með $f(x)$ og kallast gildi vörpunarinnar $f$ í $x$. Jafnframt er sagt að $f$ varpi $x$ í $f(x)$.  \\
\hline
3283 & merkingafræði & & &  \\
\hline
...
\hline
3955 & óþættanleg margliða & & &  \\
\hline
3956 & óþættanleg Markov-keðja & & &  \\
\hline
3957 & óþættanlegur, ókljúfanlegur, ókleyfur & & &  \\
\hline
3958 & óþættanlegur, ókljúfanlegur, ókleyfur & & &  \\
\hline
...
4001 & punktur, depill & & &  \\
\hline
4002 & Pýþagórasarregla, setning Pýþagórasar & & &  \\
\hline
...
4172 & rétthyrndur & & &  \\
\hline
4173 & rétthyrndur þríhyrningur & 
<ref idTerm=6438>Þríhyrningur</ref> með eitt <ref idTerm=4167>rétt horn</ref>
%<ref idTerm=6438>Þríhyrningur</ref> þar sem eitt <ref idTerm=2198>horna</ref> hans er <ref idTerm=4167>rétt horn</ref> 
& &  \\
\hline
4174 & rétthyrni & & &  \\
\hline
...
4214 & röðuð skipting & & &  \\
\hline
4215 & röðun, hlutröðun, raðvensl & & &  \\
\hline
4216 & röðunareinsmótun, raðeinsmótun & & &  \\
\hline
4217 & röðunarfrumsenda, raðfrumsenda, röðunarfrumsetning, raðfrumsetning & & &  \\
\hline
4218 & röðunargrannmynstur & & &  \\
\hline
4219 & röðunarsjálfmótun, raðsjálfmótun & & &  \\
\hline
4220 & róf, litróf & & &  \\
\hline
...
4231 & rökfasti & & &  \\
\hline
4232 & rökfesta, stærðfræðileg rökfesta & & &  \\
\hline
4233 & rökfræði & & &  \\
\hline
4234 & rökfræði annarrar stéttar & & &  \\
\hline
4235 & rökfræði fyrstu stéttar & & &  \\
\hline
4236 & rökfræðilegur, rök-, röklegur, rökrænn & & &  \\
\hline
4237 & rökfrumsenda, rökfrumsetning & & &  \\
\hline
4238 & rökhenda & & &  \\
\hline
4239 & rökhyggja & & &  \\
\hline
4240 & rökleiðsla, röksemdafærsla & & &  \\
\hline
4241 & rökleiðsluregla, rökregla, ályktunarregla, afleiðsluregla & & &  \\
\hline
4242 & rökreikningur & & &  \\
\hline
4243 & röktákn & & &  \\
\hline
4244 & röktenging, röktengill, tengill, tenging & & &  \\
\hline
4245 & rökvilla & & &  \\
\hline
4246 & rökvirki & & &  \\
...
4659 & síun & & &  \\
\hline
4660 & sívalningsflötur & <ref idTerm=1075>Faldmengi</ref> $\mathcal{C} \times I$ þar sem $\mathcal{C} \in \mathbb{R}^2$ er <ref idTerm=1131>ferill</ref> og $I \subseteq \mathbb{R}$ & &  \\
\hline
4661 & sívalningshnit & & &  \\
\hline
...
5107 & stærðfræði & & &  \\
\hline
5108 & stærðfræðileg bestun, bestun & & &  \\
\hline
5109 & stærðfræðileg frumsenda, stærðfræðileg frumsetning & & &  \\
\hline
5110 & stærðfræðileg rökfræði & & &  \\
\hline
5111 & stærðfræðileg tölfræði & & &  \\
\hline
5112 & stærðfræðileg þversögn & & &  \\
\hline
5113 & stærðfræðilegt líkan & & &  \\
\hline
5114 & stærðfræðilegur hlutur & & &  \\
\hline
5115 & stærðfræðilegur, stærðfræði- & & &  \\
\hline
...
\hline
5121 & stærsti samdeilir, stærsti sameiginlegi deilir & <ref idTerm=5118>Stærsta</ref> <ref idTerm=3475>náttúrulega talan</ref> sem <ref idTerm=1599>gengur upp í</ref> tveim <ref idTerm=1896>heiltölum</ref> $n$ og $m$  kallast \textit{stærsti} <ref idTerm=4332>\textit{samdeilir}</ref> $n$ og $m$ & & Táknað með $\text{ssd}(n,m)$ á íslensku? Held að flestir myndu frekar þekkja $\text{gcd}(n,m)$ & &  \\
\hline
5122 & stafræn tölva & & &  \\
\hline
5123 & stafrænn & & &  \\
...
5415 & talnakerfi & & &  \\
\hline
5416 & talnalína, talnaás, rauntalnalína, rauntalnaás, raunás & & &  \\
\hline
5417 & talnalykill & & &  \\
\hline
...
\hline
5610 & tugafylling, tugafyllitala & & &  \\
\hline
5611 & tugakerfi & & &  \\
\hline
...
Að skrifa töluna $n$ á þessu formi kallast að \textit{frumþátta} hana. <ref idTerm=5397>Tölurnar</ref> $p_{1}, \ldots, p_{k}$ kallast þá \textit{frumþættir} tölunnar $n$ og $a_{i}$ kallast <ref idTerm=3127>\textit{margfeldni}</ref> frumþáttarins $p_{i}$ & &  \\
\hline
5825 & undirsumma & & &  \\
\hline
...
6148 & vindingsgrúpa & & &  \\
\hline
6149 & vindingslaus grúpa, vindingalaus grúpa & & &  \\
\hline
...
6163 & vinstra íðal & & &  \\
\hline
6164 & vinstri afleiða, afleiða frá vinstri & & &  \\
\hline
6165 & vinstri andhverfa, andhverfa frá vinstri & & &  \\
\hline
