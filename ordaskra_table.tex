...
\hline
234 & almennt brot & <ref idTerm=4039>Ræð tala</ref> sem er rituð sem <ref idTerm=2072>hlutfall</ref> tveggja <ref idTerm=1896>heiltalna</ref> $a$ og $b$ og táknuð $\frac{a}{b}$ & &  \\
\hline
...
1089 & fallfrymi & & &  \\
\hline
1090 & fallgildi & Fyrir <ref idTerm=1078>fall</ref> $f : X \to Y$ og <ref idTerm=5128>stak</ref> $x$ úr $Z$ kallast stakið úr $Y$ sem $f$ úthlutar $x$ \textit{gildi fallsins} $f$ í $x$ og táknað með $f(x)$ & &  \\
\hline
1091 & fallgildi & & &  \\
\hline
